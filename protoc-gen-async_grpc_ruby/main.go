...
import (
	...
	"github.com/shidel-dev/async-grpc/protoc-gen-async_grpc_ruby/typemap"
...
func (g *generator) Generate() *plugin.CodeGeneratorResponse {
	...
	for _, f := range g.genFiles {
		twirpFileName := noExtension(filePath(f)) + "_service_def.rb"       // e.g. "hello_world/foo_service_def.rb"
		pbFileRelativePath := noExtension(onlyBase(filePath(f))) + "_pb.rb" // e.g. "foo_pb.rb"
...
func (g *generator) generateRubyCode(file *descriptor.FileDescriptorProto, pbFileRelativePath string) string {
	b := new(bytes.Buffer)
	print(b, "# Code generated by protoc-gen-async_grpc_ruby %s, DO NOT EDIT.", g.version)
	print(b, "require 'async/grpc'")
	...
	for i, service := range file.Service {
		...
		print(b, "%sclass %sService", indent, camelCase(svcName))
		print(b, "%s  include Async::GRPC::Service", indent)
		if pkgName != "" {
